using AutoMapper;
using EntityG.Application.Exceptions;
using EntityG.Application.Interfaces.Services.Identity;
using EntityG.Application.Interfaces.Shared;
using EntityG.Application.Requests.Identity;
using EntityG.Application.Requests.Mail;
...
namespace EntityG.Infrastructure.Services.Identity
{
    public class UserService : IUserService
    {
        ...
        public UserService(UserManager<ApplicationUser> userManager, IMapper mapper, RoleManager<IdentityRole> roleManager, IMailService mailService)
        {
