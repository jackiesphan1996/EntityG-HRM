...
namespace EntityG.Test.Core.Helpers
{
    public static class LoggerHelper
    {
      
        public static void VerifyLogError<T>(this Mock<ILogger<T>> loggerMock, Exception expectedException, string message)
        {
            loggerMock.Verify(x => x.Log(
                LogLevel.Error,
                It.IsAny<EventId>(),
                It.Is<It.IsAnyType>((v, t) => v.ToString().Equals(message)),
                It.Is<Exception>(e => e.GetType() == expectedException.GetType()),
