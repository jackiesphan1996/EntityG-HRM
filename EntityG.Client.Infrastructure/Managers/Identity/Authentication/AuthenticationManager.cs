    ...
    public class AuthenticationManager : IAuthenticationManager
    {
        ...
        public async Task<IResult> Login(TokenRequest model)
        {
            ...
            if (result.Succeeded)
            {
                ...
                ((EntityGBlazorStateProvider)this._authenticationStateProvider).MarkUserAsAuthenticated(model.Email);
        ...
        public async Task<IResult> Logout()
        {
            ...
            ((EntityGBlazorStateProvider)_authenticationStateProvider).MarkUserAsLoggedOut();
