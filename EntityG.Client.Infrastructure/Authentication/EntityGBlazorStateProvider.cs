...
namespace EntityG.Client.Infrastructure.Authentication
{
    public class EntityGBlazorStateProvider : AuthenticationStateProvider
    {
        private readonly HttpClient _httpClient;
        private readonly ILocalStorageService _localStorage;

        public EntityGBlazorStateProvider(HttpClient httpClient, ILocalStorageService localStorage)
        {
        ...
        {
            AuthenticationState state = await this.GetAuthenticationStateAsync();
